...
async def test_session_lifecycle_and_commit(test_settings: Settings, _migrated_db: None) -> None:
...
async def test_session_rollback_on_error(test_settings: Settings, _migrated_db: None) -> None:
    await dbsession.dispose_engine()

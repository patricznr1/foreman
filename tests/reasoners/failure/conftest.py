...
#  Zweck: Geteilte Fixtures der F-PRED-/F-REC-Tests — lädt das gebündelte
#         Demonstrator-Artefakt EINMAL je Session (SHAP-Explainer ist teuer) und
#         stellt ein deterministisches Mock-Backend + Fabrik fürs ECHTE
#         LiteLLMGateway bereit (F-REC), so dass Spotlighting + Grounding-Post-Check
#         real durchlaufen (kein Netz, kein LLM-Call). Lokal definiert (keine
#         Kopplung an die F-LLM-/F6-conftest), damit die Tests eigenständig sind.
# ============================================================
